...
import { NewPostwitt } from "./NewPostwitt";
    ...
    <Transition.Root show={modalNewIsOpen} as={Fragment}>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="inline-block align-bottom bg-primary phone:rounded-2xl text-left  phone:shadow-xl 
            transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full w-full phone:w-auto h-screen phone:h-auto"
            >
              <div className="flex items-center px-1.5 py-2 border-b border-secondary">
                <div
