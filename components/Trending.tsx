  ...
  return (
    ...
    >
      <div className="space-y-0.5">
        <p className="text-terciary text-xs font-medium">{result.heading}</p>
        <h6 className="font-bold max-w-[250px] text-sm">
          {result.description}
        </h6>
        <p className="text-terciary text-xs font-medium max-w-[250px]">
          Trending with{" "}
      ...
      {result.img ? (
        ...
        <div className="icon group">
          <MoreHorizOutlinedIcon className="h-5 text-terciary group-hover:text-link" />
        </div>
      )}
    </div>
  );
